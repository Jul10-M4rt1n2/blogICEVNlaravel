...
class ContactController extends Controller
{
    ...
    public function destroy($id)
    {
        ...
        $teste = $this->model->destroy($id);
        if ($teste) {
            return redirect()->route('painel.contact')->with('success', 'Registro excluído com sucesso!');
        } else {
            return redirect()->route('painel.contact')->with('error', 'Erro ao excluir o registro!');
        }
    }
}
