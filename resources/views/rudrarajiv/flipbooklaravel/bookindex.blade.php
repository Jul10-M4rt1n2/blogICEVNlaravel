...
<div class="container">
    <div class="starter-template">
        <h1>Ver todos os livros</h1>
        <p class="lead">Aqui você encontrará uma lista de todos os Flip Books.</p>
    </div>
    <div class="row">
        @foreach($flipbooks as $fb)
            <div class="col-md-2">
                ...
                <a href="{{ route('flipbook.edit',$fb->id) }}"
                   style="float: left;clear: both;width:100%;margin-top: 10px;">
