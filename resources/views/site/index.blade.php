...
@section('content')
    <section class="body">
        <div class="img-banner">
            @if (isset($registro))
                <img src="{{ asset($registro->image) }}" alt="banner-destaque"
                     class="img-fluid img-custom custom-gradient">
            @else
                    ...
                    <div class="col-12 col-md-4 d-block">
                        @if (isset($registro))
                            <img src="{{ asset($registro->image2) }}" alt="banner-destaque"
                                 class="img-fluid img-custom custom-card-img-effect"
                ...
                <div class="col-12">
                    <div class="row">
                        ...
                        @else
                            ...
                            <p class="h5 custom-sub-title-2 custom-transition">voce é nosso convidade mais que
                                especial</p>
                        @endif
                    </div>
                    <div class="row my-5">
                        <div class="col-sm-4">
                            <div class="card custom-bord-card">
                                <div class="card-body custom-bg-section position-relative"
                                    ...
                                    @else
                                        <h5 class="card-title custom-title-italic-2 custom-transition">Culto da
                                            Família</h5>
                                        <p class="card-text custom-sub-title-2 custom-transition">Todo domingo das 19
                                            horas
                                            as
                                    ...
                                    @endif
                                    <a href="{{ route('site.detalhesPost') }}"
                                       class="btn custom-btn-success custom-card-img-effect position-absolute"
                                       style="left: 40%; bottom: 10px;">Ver mais</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="card custom-bord-card">
                                <div class="card-body custom-bg-section position-relative" style="height: 380px; overflow: hidden;">
                                    @if (isset($registro))
                                        <h5 class="card-title custom-title-italic-2 custom-transition">
                                    ...
                                    @else
                                        <h5 class="card-title custom-title-italic-2 custom-transition">Entudos bíblcos
                                            de
                                            quarta-feira (EBQ)</h5>
                                        <p class="card-text custom-sub-title-2 custom-transition">Nao conhece a palavra
                                            do
                                            Senhor a fundo? tem vontade de aprender,
                                            mas nao sabe por onde comecar? esta com duvidas e nao sabe quem pode
                                            responder?
                                            entao este é o momento a hora e o lugar para fazer as suas perguntas. Toda
                                            quarta-feira as 19:30 horas. Participe!</p>
                                    @endif
                                    <a href="{{ route('site.detalhesPost2') }}"
                                       class="btn custom-btn-success custom-card-img-effect position-absolute"
                                       style="left: 40%; bottom: 10px;">Ver mais</a>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-4">
                            <div class="card custom-bord-card">
                                <div class="card-body custom-bg-section position-relative" style="height: 380px; overflow: hidden;">
                                    ...
                                    @else
                                        <h5 class="card-title custom-title-italic-2 custom-transition">Encontro de
                                            oracao
                                        </h5>
                                        <p class="card-text custom-sub-title-2 custom-transition">Sabemos que a voz do
                                            senhor
                                            vem por meio da pregacao (romanos
                                            10:17). Mas voce sabia que pode conversas com Deus, enviando uma mensagem e
                                            Ele
                                            ti
                                            responde assim que visualiza? Esse é o poder da oracao. Encontros todas
                                            tercas-feiras as 19:30 horas em uma casa bem pertinho de voce. Venha enviar
                                            a
                                            sua
                                            mensagem pra Deus.</p>
                                    @endif
                                    <a href="{{ route('site.detalhesPost3') }}"
                                       class="btn custom-btn-success custom-card-img-effect position-absolute"
                                       style="left: 40%; bottom: 10px;">Ver mais</a>
                                </div>
                            </div>
            ...
            <div class="container text-center">
                <div class="card border-0 p-5 custom-bg-section-2" id="section-worne">
                    <div class="card-body">
                        ...
                        @else
                            <h5 class="card-title custom-title-italic-2 custom-transition">Quer saber o que ti
                                espera?</h5>
                            <p class="card-text custom-sub-title-2 custom-transition">Temos um amplo salao com
                                capacidade
                                para
                                300 pessoas, climatizados com boa custica, momentos de louvor com banda ao vivo.
                                Salinhas
                                com
                                professores que ensinan a palavra do Senhor conforme a idade de seus filhos, com
                                maternais,
                                sala
                                para criancas e adolescentes. Um amplo estacionamento fechado com vigilancia e uma
                                recepicao
                                ...
                                perfeito
                                pra voce e sua familia. Venha fazer parte da familia Vida Nova. Todos os domingos as
                                19:00
                                horas.
                            </p>
                        @endif
                        <a href="{{ route('site.detalhesPost4') }}"
                           class="btn custom-btn-success custom-card-img-effect">Ver mais</a>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-12 bg-black p-5">
            <div class="ratio ratio-16x9">
                <iframe width="1280" height="720" src="https://www.youtube.com/embed/1MP1tBTn_cs" title="A beleza do amor" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            </div>
        </div>
    </section>
@endsection
