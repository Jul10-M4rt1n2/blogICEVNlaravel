...
<div class="image-fluid">
    <img src="{{ asset('assets/image/banner-jovens.jpg') }}" alt="banner-destaque do card 1" class="img w-100  custom-gradient"
        style="height: 45rem">
</div>
                ...
                <div class="description custom-sub-title-2 custom-transition">
                    @if (!empty($post) && $post != null)
                            <p class="card-text custom-sub-title-2 custom-transition text-black">
                                {{ $post->section3_description_card3 }}</p>
                    @else
