            ...
            <div class="carousel-inner" style="height: 90vh">
                ...
                @else
                    ...
                    <div class="carousel-caption d-none d-md-block"
                        ...
                        <h5>Titulo do Estudo bíblico</h5>
                        <h3>Subtitulo</h3>
                        <p>Aqui voce verá o resumo do estudo, e escolher o que melhor de agradar. Nesta pagina será
                            reunido
                            varios generos literários desde estudos e devocionários infantis, a estudos e devocionários para estudo
                            e
            ...
            <div class="col-12">
                <div class="row">
                    <div class="title my-2">
                        <h2 class="custom-title-italic-2 custom-transition text-black">Estudos bíblicos de quarta-feira</h2>
                    </div>
                </div>
                <div class="row">
                    <!--carregar todos os registro de livros do banco de dados sendo somente image2 que é a capa do livro-->
                    @if (count($registros) > 0 && count($registros->where('category', 'ebq')) > 0)
                ...
                <div class="row">
                    <div class="title my-2">
                        <h2 class="custom-title-italic-2 custom-transition text-black">Outros</h2>
                    </div>
                </div>
                <div class="row">
                    <!--carregar todos os registro de revistas do banco de dados sendo somente image2 que é a capa do livro-->
                    @if (count($registros) > 0 && count($registros->where('category', 'outros')) > 0)
                        @foreach ($registros as $item)
                            <!--verificando se é livro ou revista conforme o select no cadastro-->
