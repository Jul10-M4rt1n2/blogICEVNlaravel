...
@section('title')
    Pagina referente a pagina de detalhes do Estudo bíblico
@endsection
    ...
    <div class="container py-5" style="margin-left: 25%;">
        <div class="row">
            <div class="col-12 colxl-12 col-lg-12 col-md-12 col-sm-12">
                <h1>Dashboard - Lista de Estudos bíblicos</h1>
                <!--retornando os erros-->
                @if ($errors->any())
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="#" method="POST" class="form form-inline">
                                ...
                                <a href="{{ route('painel-studies-create') }}" class="btn btn-secondary" role="button"><i class="fas fa-plus-circle"></i>Adicionar</a>
                        ...
                        @if(!$data->isEmpty())
                            @foreach ($data as $item)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <form action="{{ route('painel-studies-destroy', $item->id) }}" method="POST">
                                            @csrf
                                            @method('delete')
