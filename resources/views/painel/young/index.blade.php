...
@section('title')
    Pagina referente a pagina encontro de jovens do site
@endsection
    ...
    <div class="container py-5 custom-position-left-div">
        <div class="row">
            <div class="col-12 colxl-12 col-lg-12 col-md-12 col-sm-12">
                <h1>Dashboard - Encontro de Jovens</h1>
                <!--retornando os erros-->
                @if ($errors->any())
                    ...
                    <div class="card">
                        <div class="card-body overflow-auto">
                            ...
                            <form action="#" method="POST" class="form form-inline">
                                ...
                                <a href="{{ route('painel-young-create') }}" class="btn btn-secondary" role="button"><i class="fas fa-plus-circle"></i>Adicionar</a>
                            ...
                            @foreach ($data as $item)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('painel-young-edit', $item->id) }}" class="btn btn-warning"><i class="fas fa-edit"></i></a>
                                    </td>
                                    <td class="text-center">
                                        <form action="{{ route('painel-young-destroy', $item->id) }}" method="POST">
                                            @csrf
                                            @method('delete')
