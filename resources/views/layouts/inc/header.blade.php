    ...
    <nav class="navbar navbar-expand-lg custom-bg-header">
        <div class="container">
            <a class="navbar-brand text-light" href="{{ url('/') }}"><img
                    src="{{ asset('assets/image/logo-ICEVN.png') }}" alt="" class="img-logo custom-card-img-effect"></i></a>
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item custom-card-img-effect">
                        <a class="nav-link custom-text-nav" href="#"><i class="fa-solid fa-graduation-cap"></i> Estudos biblícos</a>
                    </li>
                    <li class="nav-item custom-card-img-effect">
                        <a class="nav-link custom-text-nav" href="#"><i class="fa-solid fa-circle-exclamation"></i> Quem somos</a>
                    </li>
                    <li class="nav-item custom-card-img-effect">
                        <a class="nav-link custom-text-nav" href="#"><i class="fa-solid fa-address-book"></i> Contato</a>
                    </li>
                </ul>
            </div>
        </div>
