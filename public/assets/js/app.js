...
/* harmony import */ var _home__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./home */ "./resources/js/home.js");
...
/*!
 * jQuery JavaScript Library v4.0.0-pre 2525cffc42934c0d5c7aa085bc45dd6a8282e840
 * https://jquery.com/
 *
...
(function (global, factory) {
  ...
  var _slice = arr.slice; // Support: IE 11+
  ...
  var push = arr.push;
  var indexOf = arr.indexOf; // [[Class]] -> type pairs

  var class2type = {};
  var toString = class2type.toString;
  var hasOwn = class2type.hasOwnProperty;
  var fnToString = hasOwn.toString;
  var ObjectFunctionString = fnToString.call(Object); // All support tests are defined in their respective modules.
  ...
  var version = "4.0.0-pre 2525cffc42934c0d5c7aa085bc45dd6a8282e840",
      rhtmlSuffix = /HTML$/i,
  ...
  var pop = arr.pop; // https://www.w3.org/TR/css3-selectors/#whitespace

  var whitespace = "[\\x20\\t\\r\\n\\f]";
  var isIE = document.documentMode;
  var rbuggyQSA = isIE && new RegExp( // Support: IE 9 - 11+
  // IE's :disabled selector does not pick up the children of disabled fieldsets
  ":enabled|:disabled|" + // Support: IE 11+
  // IE 11 doesn't find elements on a `[name='']` query in some cases.
  // Adding a temporary attribute to the document before the selection works
  // around the issue.
  "\\[" + whitespace + "*name" + whitespace + "*=" + whitespace + "*(?:''|\"\")");
  var rtrim = new RegExp("^" + whitespace + "+|((?:^|[^\\\\])(?:\\\\.)*)" + whitespace + "+$", "g"); // Note: an element does not contain itself
  ...
  var hasDuplicate; // Document order sorting
  ...
  (function () {
        ...
        if (documentIsHTML) {
          ...
          if (nodeType !== 11 && (match = rquickExpr.exec(selector))) {
            ...
            if (m = match[1]) {
              ...
              if (nodeType === 9) {
                ...
                return results; // Element context
              } else {
          ...
          if (!nonnativeSelectorCache[selector + " "] && (!rbuggyQSA || !rbuggyQSA.test(selector))) {
            ...
            if (nodeType === 1 && (rdescend.test(selector) || rcombinators.test(selector))) {
              ...
              newContext = rsibling.test(selector) && testContext(context.parentNode) || context; // Outside of IE, if we're not changing the context we can
    ...
    function setDocument(node) {
      ...
      documentIsHTML = !jQuery.isXMLDoc(document); // Support: IE 9 - 11+
      ...
      if (isIE && preferredDoc != document && (subWindow = document.defaultView) && subWindow.top !== subWindow) {
    ...
    Expr = jQuery.expr = {
      ...
      filter: {
        ...
        PSEUDO: function PSEUDO(pseudo, argument) {
          ...
          var args,
              fn = Expr.pseudos[pseudo] || Expr.setFilters[pseudo.toLowerCase()] || selectorError("unsupported pseudo: " + pseudo); // The user may use createPseudo to indicate that
    ...
    function tokenize(selector, parseOnly) {
      ...
      return soFar ? selectorError(selector) : // Cache the tokens
  ...
  var rneedsContext = jQuery.expr.match.needsContext; // rsingleTag matches a string consisting of a single HTML element with no attributes
  ...
  rquickExpr = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/,
    ...
    root = root || rootjQuery; // HANDLE: $(DOMElement)
    ...
    if (selector.nodeType) {
      ...
      if (isObviousHtml(match)) {
        ...
        // like TrustedHTML.
        match = [null, selector, null]; // Handle HTML strings or selectors
      ...
      ["notify", "progress", jQuery.Callbacks("memory"), jQuery.Callbacks("memory"), 2], ["resolve", "done", jQuery.Callbacks("once memory"), jQuery.Callbacks("once memory"), 0, "resolved"], ["reject", "fail", jQuery.Callbacks("once memory"), jQuery.Callbacks("once memory"), 1, "rejected"]],
        ...
        pipe() {
          ...
          return jQuery.Deferred(function (newDefer) {
            jQuery.each(tuples, function (_i, tuple) {
              ...
              var fn = typeof fns[tuple[4]] === "function" && fns[tuple[4]]; // deferred.progress(function() { bind to newDefer or newDefer.notify })
        ...
        then: function then(onFulfilled, onRejected, onProgress) {
          ...
          return jQuery.Deferred(function (newDefer) {
            ...
            tuples[0][3].add(resolve(0, newDefer, typeof onProgress === "function" ? onProgress : Identity, newDefer.notifyWith)); // fulfilled_handlers.add( ... )

            tuples[1][3].add(resolve(0, newDefer, typeof onFulfilled === "function" ? onFulfilled : Identity)); // rejected_handlers.add( ... )
  ...
  var cssExpand = ["Top", "Right", "Bottom", "Left"]; // isHiddenWithinTree reports if an element has a non-"none" display style (inline and/or
  ...
  var rmsPrefix = /^-ms-/; // Convert dashed to camelCase, handle vendor prefixes.
  ...
  var isAttached$1 = isAttached; // rtagName captures the name from the first start tag in a string of HTML
  ...
  function buildFragment(elems, context, scripts, selection, ignored) {
    ...
    for (; i < l; i++) {
      ...
      if (elem || elem === 0) {
        ...
        if (toType(elem) === "object" && (elem.nodeType || isArrayLike(elem))) {
          ...
          wrap = wrapMap[tag] || arr; // Create wrappers & descend into them.
    ...
    while (elem = nodes[i++]) {
      ...
      attached = isAttached$1(elem); // Append to fragment
  ...
  jQuery.Event = function (src, props) {
    ...
    if (src && src.type) {
      ...
      this.isDefaultPrevented = src.defaultPrevented ? returnTrue : returnFalse; // Create target properties
  ...
  rnoInnerhtml = /<script|<style|<link/i; // Prefer a tbody over its parent table for containing new rows
  ...
  jQuery.extend({
    ...
    clone: function clone(elem, dataAndEvents, deepDataAndEvents) {
      var i,
          ...
          inPage = isAttached$1(elem); // Fix IE cloning issues
  ...
  function getStyles(elem) {
    ...
    var view = elem.ownerDocument.defaultView; // `document.implementation.createHTMLDocument( "" )` has a `null` `defaultView`
  ...
  function curCSS(elem, name, computed) {
    ...
    computed = computed || getStyles(elem); // getPropertyValue is needed for `.css('--customProperty')` (gh-3144)
  ...
  (function () {
    ...
    support.reliableTrDimensions = function () {
      ...
      if (reliableTrDimensionsVal == null) {
        ...
        tr.style.height = "1px";
        div.style.height = "9px"; // Support: Android Chrome 86+
  ...
  function getWidthOrHeight(elem, dimension, extra) {
    ...
    boxSizingNeeded = isIE || extra,
        ...
        offsetProp = "offset" + dimension[0].toUpperCase() + dimension.slice(1); // Return a confounding non-pixel value or feign ignorance, as appropriate.
    ...
    if ( // Fall back to offsetWidth/offsetHeight when value is "auto"
    ...
    jQuery.cssHooks[dimension] = {
      get: function get(elem, computed, extra) {
        if (computed) {
          ...
          return rdisplayswap.test(jQuery.css(elem, "display")) && ( // Support: Safari <=8 - 12+, Chrome <=73+
      ...
      set: function set(elem, value, extra) {
        ...
        isBorderBox = extra && jQuery.css(elem, "boxSizing", false, styles) === "border-box",
            subtract = extra ? boxModelAdjustment(elem, dimension, extra, isBorderBox, styles) : 0; // Convert to pixels if value adjustment is needed
    ...
    val: function val(value) {
      ...
      if (!arguments.length) {
        if (elem) {
          ...
          ret = elem.value; // Handle cases where value is null/undef or number
  ...
  if (isIE) {
    jQuery.valHooks.option = {
      get: function get(elem) {
        ...
        return val != null ? val : // Support: IE <=10 - 11+
    ...
    return {
      send: function send(headers, complete) {
        ...
        _callback = function callback(type) {
          return function () {
            if (_callback) {
              _callback = xhr.onload = xhr.onerror = xhr.onabort = xhr.ontimeout = null;
        ...
        xhr.onabort = xhr.onerror = xhr.ontimeout = _callback("error"); // Create the abort callback
